 ...
 * 
 */
UCLASS(ClassGroup = "Collision", editinlinenew, hidecategories = (Object, LOD, Lighting, TextureStreaming), meta = (DisplayName = "Oxygen Zone", BlueprintSpawnableComponent))
class SPECIALIZATION_API UOxygenZone : public USphereComponent
{
	GENERATED_BODY()
