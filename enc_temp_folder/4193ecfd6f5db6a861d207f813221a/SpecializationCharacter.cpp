...
void ASpecializationCharacter::UnPossess_Implementation()
{
	...
	FAttachmentTransformRules ATR(EAttachmentRule::KeepWorld, EAttachmentRule::KeepWorld, EAttachmentRule::KeepWorld, false);

	CameraSocket->AttachToComponent(RootComponent, ATR, NAME_None);
